...
class ContactSpinnerAdapter(ctx: Context) : SpinnerAdapter {
    override fun getDropDownView(position: Int, convertView: View, parent: ViewGroup): View? {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.context).inflate(R.layout.spinner_item, null)
            convertView.tag = convertView.findViewById(R.id.labelText)
        }
        (convertView.tag as TextView).text = sValueList!![position]
        return convertView
    }
    ...
    companion object {
        ...
        var sValueList: Array<String>? = null
        ...
        fun getIndices(values: Array<String>): IntArray {
            ...
            for (valueShown in values) {
                ...
                if (Patterns.PHONE.matcher(valueShown).matches() || valueShown.contains("(") && valueShown.contains(")")) {
