 ...
 * {@link Camera2Source.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class Camera2Source {
    ...
    static int mCameraHeight, mCameraWidth;
    ...
    public Camera2Source start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public Camera2Source start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @SuppressLint("InlinedApi")
    private CameraDevice createCamera() {
        int requestedCameraId = getIdForRequestedCamera(mFacing);
        if (requestedCameraId == -1) {
            throw new RuntimeException("Could not find requested camera.");
        }
        CameraManager manager = (CameraManager) mContext.getSystemService(Context.CAMERA_SERVICE);
//        CameraDevice camera = manager.openCamera(requestedCameraId);
//
